  ...
  useEffect(() => {
    async function cargar() {
      ...
      if (res.ok) {
        ...
        inyectarProductSchema({ slug: data.slug, nombre: data.nombre, marca: data.marca, descripcion: data.descripcion, precio: data.precio, stock: data.stock, categoria: data.categoria, sku: data.sku, imagenes: data.producto_imagenes || [], tipo: 'cosmetico', resenas: resenasSchema })
      }
      setLoading(false)
    }
    if (slug) cargar()
