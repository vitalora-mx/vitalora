...
export default function SuplementosHeader() {
  ...
  return (
    <>
      {/* Barra superior */}
      <div style={{ background: '#0E0E0E', borderBottom: '1px solid #2A2A2A', padding: '10px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '12px', letterSpacing: '0.08em', color: '#F5F2EC' }}>
