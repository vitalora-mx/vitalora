...
const productos = [
  { id: 1, marca: 'COSRX', rutina: 'Sérum', nombre: 'Advanced Snail 96 Mucin Power Essence', precio: '$649 MXN', tag: 'Best Seller', color: 'linear-gradient(135deg, #F5E8E0, #E8C9C0)' },
  { id: 2, marca: 'Skin1004', rutina: 'Sérum', nombre: 'Madagascar Centella Ampoule', precio: '$580 MXN', tag: 'Nuevo', color: 'linear-gradient(135deg, #E8EBE2, #A8B5A0)' },
  { id: 3, marca: 'Anua', rutina: 'Tónico & Mist', nombre: 'Heartleaf 77% Soothing Toner', precio: '$520 MXN', tag: 'Best Seller', color: 'linear-gradient(135deg, #EDE6D8, #D9D2C4)' },
  { id: 4, marca: 'Tocobo', rutina: 'Protector Solar', nombre: 'Bio Watery Sun Cream SPF 50+', precio: '$490 MXN', tag: '', color: 'linear-gradient(135deg, #F5F0E8, #EDE6D8)' },
  { id: 5, marca: 'Medicube', rutina: 'Sérum', nombre: 'Red Erasing Serum', precio: '$720 MXN', tag: 'Popular', color: 'linear-gradient(135deg, #F5E8E0, #E8C9C0)' },
  { id: 6, marca: 'Round Lab', rutina: 'Limpiador & Exfoliante', nombre: 'Birch Juice Moisturizing Cleanser', precio: '$420 MXN', tag: '', color: 'linear-gradient(135deg, #E8EBE2, #A8B5A0)' },
  { id: 7, marca: 'Purito', rutina: 'Protector Solar', nombre: 'Centella Green Level Unscented Sun SPF50+', precio: '$510 MXN', tag: 'Vegano', color: 'linear-gradient(135deg, #D8DDD0, #A8B5A0)' },
  { id: 8, marca: 'Numbuzin', rutina: 'Sérum', nombre: 'No.3 Poreless Concentrated Essence', precio: '$680 MXN', tag: 'Nuevo', color: 'linear-gradient(135deg, #EDE6D8, #D9D2C4)' },
  { id: 9, marca: 'Abib', rutina: 'Tónico & Mist', nombre: 'Mild Acidic pH Sheet Mask', precio: '$380 MXN', tag: '', color: 'linear-gradient(135deg, #F5E8E0, #E8C9C0)' },
  { id: 10, marca: 'Celimax', rutina: 'Crema & Balm', nombre: 'Noni Energy Moisture Cream', precio: '$550 MXN', tag: 'Best Seller', color: 'linear-gradient(135deg, #E8EBE2, #A8B5A0)' },
  { id: 11, marca: 'Dr Althea', rutina: 'Sérum', nombre: 'Retinol Intense Repair Serum', precio: '$610 MXN', tag: '', color: 'linear-gradient(135deg, #EDE6D8, #D9D2C4)' },
  { id: 12, marca: 'Elizavecca', rutina: 'Mascarillas & Parche', nombre: 'Milky Piggy Carbonated Bubble Clay Mask', precio: '$460 MXN', tag: 'Popular', color: 'linear-gradient(135deg, #F5F0E8, #EDE6D8)' },
  { id: 13, marca: 'Mary & May', rutina: 'Crema & Balm', nombre: 'Collagen Peptide Vital Mask Pack', precio: '$530 MXN', tag: '', color: 'linear-gradient(135deg, #F5E8E0, #E8C9C0)' },
  { id: 14, marca: 'Mixsoon', rutina: 'Sérum', nombre: 'Bean Essence', precio: '$590 MXN', tag: 'Nuevo', color: 'linear-gradient(135deg, #E8EBE2, #A8B5A0)' },
  { id: 15, marca: 'Nineless', rutina: 'Cuidado de Ojos', nombre: 'Peptide Eye Cream', precio: '$640 MXN', tag: '', color: 'linear-gradient(135deg, #EDE6D8, #D9D2C4)' },
  { id: 16, marca: 'Rootree', rutina: 'Limpiador & Exfoliante', nombre: 'Mobitherapy Cleansing Foam', precio: '$410 MXN', tag: '', color: 'linear-gradient(135deg, #D8DDD0, #A8B5A0)' },
  { id: 17, marca: "D'ALBA", rutina: 'Protector Solar', nombre: 'Waterfull Tone-up Sun Cream SPF50+', precio: '$560 MXN', tag: 'Best Seller', color: 'linear-gradient(135deg, #F5E8E0, #E8C9C0)' },
  { id: 18, marca: 'Unleashia', rutina: 'Make Up', nombre: 'Sheer Bloggers Cushion', precio: '$670 MXN', tag: 'Nuevo', color: 'linear-gradient(135deg, #F5F0E8, #EDE6D8)' },
  { id: 19, marca: 'Eqqual Berry', rutina: 'Crema & Balm', nombre: 'Barrier Repair Moisture Cream', precio: '$480 MXN', tag: '', color: 'linear-gradient(135deg, #E8EBE2, #A8B5A0)' },
  { id: 20, marca: 'COSRX', rutina: 'Parches para Acné', nombre: 'Acne Pimple Master Patch', precio: '$280 MXN', tag: 'Best Seller', color: 'linear-gradient(135deg, #EDE6D8, #D9D2C4)' },
]
          ...
          <div style={{ position: 'relative' }} ref={dropdownRef}>
            <button
              ...
              style={{
                ...
                padding: '10px 20px',
                border: '1px solid',
                borderColor: marcasSeleccionadas.length > 0 ? 'var(--gold)' : '#E8E0D5',
                borderRadius: '100px',
                background: marcasSeleccionadas.length > 0 ? 'var(--gold)' : 'white',
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', paddingBottom: '12px', borderBottom: '1px solid #E8E0D5' }}>
                  ...
                  {marcasSeleccionadas.length > 0 && (
                    <button onClick={limpiarMarcas} style={{ background: 'none', border: 'none', fontSize: '11px', color: 'var(--gold)', cursor: 'pointer', fontFamily: 'inherit', letterSpacing: '0.1em' }}>
                      Limpiar
                    </button>
                  )}
                </div>
              ...
              >
                ...
                <div style={{ padding: '16px' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <button style={{ padding: '8px 16px', background: '#0E0E0E', color: 'white', border: 'none', fontSize: '11px', letterSpacing: '0.1em', cursor: 'pointer', borderRadius: '2px', fontFamily: 'inherit' }}>+ Agregar</button>
                  </div>
                </div>
              </div>
            ))
