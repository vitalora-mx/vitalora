...
// Ancla exacta con flexWrap: 'wrap' (10 espacios de indentacion)
const ancla = "          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '8px' : '12px', flexWrap: 'wrap' }}>"

if (!content.includes(ancla)) {
  console.log('No se encontro el ancla. Abortado.')
  process.exit(1)
}
...
console.log('Listo: barra de busqueda insertada en suplementos.')
