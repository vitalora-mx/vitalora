...
// Cierre real (indentacion: 12, 10, 8 espacios):
//             ))}
//           </div>
//         )}
const ancla = "            ))}\n          </div>\n        )}"
...
if (!content.includes(ancla)) {
  console.log('No se encontro el cierre con esa indentacion. Abortado.')
  process.exit(1)
}
...
console.log('Listo: botones de paginacion insertados en cosmeticos.')
